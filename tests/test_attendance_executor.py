...
from sql_executor import execute_sql_query, execute_attendance_query, _build_attendance_base_scope, _resolve_attendance_dates
...
def test_resolve_attendance_dates():
    from_d, to_d = _resolve_attendance_dates("daily", {"from_date": "2026-07-01", "to_date": "2026-07-31"})
