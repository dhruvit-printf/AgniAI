...
class TestReliability(unittest.TestCase):
    ...
    def test_retry_policy_transient_http(self, mock_sleep, mock_post):
        ...
        mock_post.side_effect = [mock_resp_503, mock_resp_502, mock_resp_429, mock_resp_200]
    ...
    def test_circuit_breaker_trip_and_recover(self, mock_post):
        ...
        self.assertEqual(err, "Circuit breaker is open. Backend is temporarily unreachable.")
    ...
    def test_llm_failure_isolation(self, mock_call_dotnet, mock_gen_report):
        ...
        self.assertEqual(response_payload["introMessage"], "Report generated with partial metrics.")
