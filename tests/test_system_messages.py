...
class TestSystemMessages(unittest.TestCase):
    def test_query_processing_not_understood_messages(self):
        ...
        self.assertEqual(main_msg, "I didn't quite understand that - could you please rephrase?")
    ...
    def test_database_connection_messages(self):
        ...
        self.assertEqual(main_msg, "I'm having trouble reaching the database right now.")
    ...
    def test_specific_record_not_found_messages(self):
        ...
        self.assertEqual(main_msg, "I searched for that specific record but couldn't find it.")
