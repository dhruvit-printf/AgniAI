...
from sql_executor import execute_sql_query, execute_medical_query, _build_medical_base_scope
...
def test_execute_medical_hospital_stats():
    def mock_run(sql, params=(), max_rows=None):
        ...
        return ([{
            "HospitalNameLocation": "Base Hospital Delhi",
            "AgniveerCount": 25
        }], None)

    intent = {
        "category": "Medical",
        "operation": "HospitalStats"
    }
