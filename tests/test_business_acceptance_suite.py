...
def _pick_scope(
    ...
    values = {
        ...
        "agniveer": [
            (
                "A0701905F",
                {"agniveerNo": "A0701905F"},
                {"Agniveer.AgniveerNo": "A0701905F"},
            ),
            (
                "A0701763P",
                {"agniveerNo": "A0701763P"},
                {"Agniveer.AgniveerNo": "A0701763P"},
            ),
            (
                "A0701515Y",
                {"agniveerNo": "A0701515Y"},
                {"Agniveer.AgniveerNo": "A0701515Y"},
            ),
            (
                "A0701622K",
                {"agniveerNo": "A0701622K"},
                {"Agniveer.AgniveerNo": "A0701622K"},
            ),
        ],
        "date": [
            ("today", {"date": "today"}, {}),
...
def _make_simple_case(
    ...
    *,
    ...
    expected_response_type = (
        "Detailed"
        if category
        in {"Leave", "Medical", "Equipment", "personaldetail", "disqualified"}
        else "Summary"
    )
...
def _build_simple_cases() -> List[AcceptanceCase]:
    base_specs = [
        (
            ...
            "company",
            "Performance",
            ("SELECT TOP", "AgniveerScoreAttempt", "GROUP BY", "ORDER BY"),
            (),
        ),
        (
            "SIMP-002",
            "Show bottom BPET performers",
            "Performance",
            "Bottom",
            "platoon",
            "Performance",
        ...
        (
            "SIMP-003",
            "Show average BPET score",
            "Performance",
            "Average",
            "batch",
            "Performance",
            ("AVG(", "ScoreSectionMaster", "GROUP BY"),
            (),
        ),
        (
            "SIMP-004",
            "Show BPET grading summary",
            "Performance",
            "GradingSummary",
            "agniveer",
            "Performance",
        ...
        (
            ...
            "company",
            "Attendance",
            ("AttendanceDateTime", "GROUP BY", "MONTH"),
            (),
        ),
        (
            "SIMP-006",
            ...
            "platoon",
            "Attendance",
            ("AttendanceDateTime", "GROUP BY", "DATEPART"),
            (),
        ),
        (
            "SIMP-007",
            ...
            "batch",
            "Attendance",
            ("AttendanceDateTime", "TOP", "ORDER BY"),
            (),
        ),
        (
            "SIMP-008",
            "Show present agniveers",
            "Attendance",
            "Present",
            "company",
            "Attendance",
            ("IsPresent", "PlatoonMaster", "CompanyMaster"),
            (),
        ),
        (
            "SIMP-009",
            ...
            "platoon",
            "Attendance",
            ("SUM(", "COUNT(", "AgniveerAttendanceMaster"),
            (),
        ),
        (
            "SIMP-010",
            "Show current leave records",
            "Leave",
            "Current",
            "batch",
            "Leave",
            ("AgniveerLeaveMaster", "BETWEEN", "GETDATE"),
            (),
        ),
        (
            "SIMP-011",
            "Show most leave taken",
            "Leave",
            "Most",
            "company",
            "Leave",
            ("AgniveerLeaveMaster", "DATEDIFF", "ORDER BY"),
            (),
        ),
        (
            "SIMP-012",
            "Show least leave taken",
            "Leave",
            "Least",
            "platoon",
            "Leave",
        ...
        (
            "SIMP-013",
            "Show absconded agniveers",
            "Leave",
            "Absconded",
            "agniveer",
            "Leave",
            ("IsAbscondedLeave", "AgniveerLeaveMaster"),
            (),
        ),
        (
            "SIMP-014",
            ...
            "company",
            "Medical",
            ("BMI", "MedicalRecordMaster", "GROUP BY"),
            (),
        ),
        (
            "SIMP-015",
        ...
        (
            ...
            "company",
            "Verification",
            ("PoliceVerificationMaster", "Pending"),
            (),
        ),
        (
            "SIMP-019",
            "Show rejected verification",
            "Verification",
            "Rejected",
            "platoon",
            "Verification",
            ("PoliceVerificationMaster", "Rejected"),
            (),
        ),
        (
            "SIMP-020",
            ...
            "batch",
            "Verification",
            ("PoliceVerificationMaster", "Completed"),
            (),
        ),
        (
            "SIMP-021",
            "Show sent verification",
            "Verification",
            "Sent",
            "agniveer",
            "Verification",
            ("PoliceVerificationMaster", "Sent"),
            (),
        ),
        (
            "SIMP-022",
            "Show not responded verification",
            "Verification",
            "NotResponded",
            "company",
            "Verification",
            ("PoliceVerificationMaster", "DaysSinceSent"),
            (),
        ),
        (
            "SIMP-023",
            "Show holding equipment",
            "Equipment",
            "Holding",
            "platoon",
            "Equipment",
            ("AgniveerEquipment", "EquipmentMaster"),
            (),
        ),
        (
            "SIMP-024",
        ...
        (
            "SIMP-025",
            "Show equipment by agniveer",
            "Equipment",
            "AgniveerWise",
            "agniveer",
            "Equipment",
            ("AgniveerEquipment", "AgniveerMaster"),
            (),
        ),
        (
            "SIMP-026",
            ...
            "company",
            "Distribution",
            ("DistributionMaster", "AgniveerRelationMaster"),
            (),
        ),
        (
            "SIMP-027",
            "Show unassigned distribution",
            "Distribution",
            "Unassigned",
            "platoon",
            "Distribution",
            ("AgniveerRelationMaster", "PlatoonMaster"),
            (),
        ),
        (
            "SIMP-028",
...
def _build_cross_filter_cases() -> List[AcceptanceCase]:
    patterns = [
        (
            "CF-001",
            "Show top BPET performers who play cricket and are currently on leave",
            "Performance",
            "cross_filter",
            "Top",
        ),
        (
            "CF-002",
            "Show top BPET performers who play football and have rejected verification",
            "Performance",
            "cross_filter",
            "Top",
        ),
        (
            "CF-003",
            "Show agniveers having poor-condition equipment and attendance below 80%",
            "Equipment",
            "cross_filter",
            "Holding",
        ),
        (
            "CF-004",
            "Show agniveers absent today and currently on medical leave",
            "Attendance",
            "cross_filter",
            "Daily",
        ),
        (
            "CF-005",
            "Show medical cases with issued equipment and rejected verification",
            "Medical",
            "cross_filter",
            "Disease",
        ),
    ...
    for case_id, question, category, qtype, op in patterns:
        for idx in range(4):
            cases.append(
                _make_compound_case(f"{case_id}-{idx+1}", question, qtype, category, op)
            )
    return cases
...
def _build_comparison_cases() -> List[AcceptanceCase]:
    patterns = [
        (
            "CMP-001",
            "Compare Alpha Company and Bravo Company performance",
            "compare",
            "Performance",
            "Compare",
        ),
        (
            "CMP-002",
            "Compare PL-01 and PL-02 attendance",
            "compare",
            "Attendance",
            "Compare",
        ),
        (
            "CMP-003",
            "Compare medical cases of Alpha Company and Bravo Company",
            "compare",
            "Medical",
            "Compare",
        ),
        (
            "CMP-004",
            "Compare verification status between Batch 1 and Batch 2",
            "compare",
            "Verification",
            "Compare",
        ),
        (
            "CMP-005",
            "Compare equipment distribution company-wise",
            "compare",
            "Distribution",
            "Compare",
        ),
...
def _build_trend_cases() -> List[AcceptanceCase]:
    patterns = [
        ...
        (
            "TRD-002",
            "Show attendance trend for Alpha Company",
            "trend",
            "Attendance",
            "Monthly",
        ),
        (
            "TRD-003",
            "Show verification completion trend",
            "trend",
            "Verification",
            "Sent",
        ),
        (
            "TRD-004",
            "Show equipment distribution trend",
            "trend",
            "Distribution",
            "Latest",
        ),
...
def _build_aggregation_cases() -> List[AcceptanceCase]:
    patterns = [
        ...
        (
            "AGG-004",
            "Count of rejected verifications",
            "simple",
            "Verification",
            "Rejected",
        ),
...
def _assert_expected_intent(case: AcceptanceCase, intent: Dict[str, Any]) -> None:
    for key, value in case.expected_intent.items():
        ...
        ), f"{case.test_id}: expected intent[{key!r}]={value!r}, got {intent.get(key)!r}"
...
def _build_ast_and_sql(case: AcceptanceCase) -> Tuple[ASTNode, str, List[Any]]:
    ...
    assert (
        executor_err is None
    ), f"{case.test_id}: executor validator rejected SQL: {executor_err}"
    for token in case.expected_sql_contains:
        assert (
            token.lower() in sql.lower()
        ), f"{case.test_id}: expected SQL to contain {token!r}"
    for token in case.expected_sql_not_contains:
        assert (
            token.lower() not in sql.lower()
        ), f"{case.test_id}: expected SQL not to contain {token!r}"
