...
def test_explainability_advanced_features():
    ...
    ast.aggregates = [AggregateNode(column="AgniveerMaster.Id", function="COUNT", alias="Total")]
    ...
    assert "Calculated COUNT of AgniveerMaster.Id (as Total)" in explanation["aggregations"]
