...
class SchemaEngine:
    ...
    def __init__(
        self,
        schema_path: str = "actual_schema.json",
        ontology_path: str = "business_ontology.json",
    ):
    ...
    def get_column_type(self, table_name: str, column_name: str) -> str:
        ...
        if (
            ...
            or column_name == "Id"
            or "No" in column_name
            or column_name.endswith("Total")
        ):
            return "integer"
    ...
    _FK_OVERRIDES: Dict[Tuple[str, str], Dict[str, str]] = {
        ("MedicalRecordMaster", "DoctorId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("AgniveerScoreAttempt", "EvaluatedBy"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("AgniveerAttendanceMaster", "MarkedBy"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("AgniveerLeaveMaster", "MarkedBy"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("UserMaster", "AgniVeerId"): {
            "referenced_table": "AgniveerMaster",
            "referenced_column": "Id",
        },
        ("AgniveerMaster", "SponserUnitId"): {
            "referenced_table": "DistributionMaster",
            "referenced_column": "Id",
        },
        ("DistributionHistoryMaster", "TeamId"): {
            "referenced_table": "DistributionMaster",
            "referenced_column": "Id",
        },
        ("CompanyMaster", "CompanyCommanderId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("CompanyMaster", "CommandingOfficerId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("PlatoonMaster", "PlatoonCommanderId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("CompanyCommanderHistory", "CommanderId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("CompanyCommandingOfficerHistory", "CommandingOfficerId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
        ("PlatoonCommanderHistory", "CommanderId"): {
            "referenced_table": "UserMaster",
            "referenced_column": "Id",
        },
    }
            ...
            if col.endswith("Id") and col != "Id":
                ...
                # Add special cases for relationship graph
                    ...
                    fks.append(
                        {
                            "column": col,
                            "referenced_table": "ScoreSubItemMaster",
                            "referenced_column": "Id",
                        }
                    )
                    ...
                    fks.append(
                        {
                            "column": col,
                            "referenced_table": "ScoreSectionMaster",
                            "referenced_column": "Id",
                        }
                    )
        return fks
        ...
        for t in self.get_tables():
            ...
            for fk in self.get_foreign_keys(t):
                if fk["referenced_table"] == table_name:
                    rev.append({"table": t, "column": fk["column"]})
        return rev
    ...
    def get_searchable_columns(self, table_name: str) -> List[str]:
        ...
        return [
            ...
            if self.get_column_type(table_name, c) == "string"
        ]
    ...
    def get_aggregation_columns(self, table_name: str) -> List[str]:
        ...
        return [
            c
            for c in self.get_columns(table_name)
            if self.get_column_type(table_name, c) in ["integer", "float"]
    ...
    def get_status_columns(self, table_name: str) -> List[str]:
        ...
        return [
            c
            for c in self.get_columns(table_name)
            if "Status" in c or c.startswith("Is") or c.startswith("On")
        ]
    ...
    def get_date_columns(self, table_name: str) -> List[str]:
        ...
        return [
            c
            for c in self.get_columns(table_name)
            if self.get_column_type(table_name, c) == "datetime"
        ]
