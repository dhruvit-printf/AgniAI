...
IF NOT EXISTS (SELECT 1 FROM sys.server_principals WHERE name = 'agniai_reporting')
BEGIN
    CREATE LOGIN agniai_reporting
...
IF NOT EXISTS (SELECT 1 FROM sys.database_principals WHERE name = 'agniai_reporting')
BEGIN
    CREATE USER agniai_reporting FOR LOGIN agniai_reporting;
END
GO
...
IF EXISTS (SELECT 1 FROM sys.database_principals WHERE name = 'db_datawriter')
BEGIN
    ALTER ROLE db_datawriter DROP MEMBER agniai_reporting;
END
GO
