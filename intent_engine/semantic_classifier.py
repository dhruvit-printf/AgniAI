...
_CATALOG: List[Tuple[str, str, str]] = [
    ...
    ("Performance", "Bottom", "who needs improvement in ppt"),
    ("Performance", "Bottom", "which agniveer failed in firing"),
    ...
    ("Performance", "Grading", "who failed in firing"),
    ("Performance", "Grading", "which agniveers failed in bpet"),
    ("Performance", "Grading", "list of agniveers who failed"),
    ("Performance", "Grading", "show agniveers failing in drill"),
    ...
    ("Leave", "Most", "who has already used more than 90% of their leaves"),
    ("Leave", "Most", "which agniveer are close to exhausting their leave quota"),
    ("Leave", "Least", "agniveers with least days absent"),
    ("Leave", "Least", "who is most regular with attendance"),
    ("Leave", "Least", "who has the best leave records"),
    ...
    ("Medical", "Disease", "how many people have malaria"),
    ("Medical", "Disease", "who is suffering from viral fever"),
    ("Medical", "Disease", "agniveers with common cold or flu"),
