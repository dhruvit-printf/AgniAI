...
OPERATION_SYNONYMS: Dict[str, Dict[str, Tuple[str, ...]]] = {
    ...
    "Leave": {
        ...
        "Threshold": (
            # Continuous 40-44 days OR total 55-59 days (~90% of the leave
            # allowance) — see sql_executor._execute_leave_threshold. Users
            # rarely say "threshold" outright; they name the day count or
            # percentage instead.
            "threshold",
            "above threshold",
            "leave threshold",
