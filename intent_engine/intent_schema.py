...
OPERATION_SYNONYMS: Dict[str, Dict[str, Tuple[str, ...]]] = {
    ...
    "Leave": {
        ...
        "Threshold": (
            ...
            "90 percent",
            "90% of their leave",
            "90 percent of their leave",
            "used up 90 percent",
            "near leave limit",
            "near the limit",
            "close to the limit",
            "almost exhausted",
            "almost exhausted their leave",
            "about to exhaust",
            "about to cross the threshold",
            "about to hit the limit",
            "about to complete their leave",
            "about to get threshold",
            "high leave usage",
            "critical leave",
            "leave risk",
            "leave utilization",
    ...
    "Medical": {
        ...
        "HospitalStats": (
            ...
            "hospital wise count",
            "treatment count by hospital",
            "which hospital sees the most cases",
            "hospital case load",
            "top hospital for treatment",
            "hospital with most admissions",
            "hospital utilization",
            "hospital breakdown",
            "admissions by hospital",
            "which hospital is used most",
            "hospital referral stats",
            "referral hospital count",
        ),
    },
    "Attendance": {
        "Monthly": (
        ...
        "Weekly": (
            ...
            "week on week attendance",
            "how was attendance this past week",
    ...
    "Equipment": {
        ...
        "AgniveerWise": (
            ...
            "list of items per agniveer",
            "what's issued to each person",
            "equipment list by person",
            "agniveer equipment list",
            "gear list per person",
            "kit list by agniveer",
            "who has what gear",
            "personal kit list",
        ),
    },
    "Distribution": {
        "Latest": (
            ...
            "just distributed",
            "recent allocation",
            "what got handed out last",
            "most recent handout",
            "last batch handed out",
        ),
        "ByUnit": (
            "show by unit",
            "split by unit",
    ...
    "Verification": {
        ...
        "Sent": (
            ...
            "sent out for verification",
            "verification dispatched",
            "requests already sent out",
            "forwarded",
            "submitted",
            "verification sent out",
            "sent for checking",
            "request went out",
        ),
        "NotResponded": (
        ...
        "Rejected": (
            ...
            "disapproved",
            "verification denied",
            "verification came back negative",
            "failed verification",
            "kicked back",
            "sent back for correction",
            "verification is failed",
            "police verification is failed",
            "police verification failed",
            "his verification failed",
    ...
    "Schedule": {
        ...
        "bycompany": (
            ...
            "what's company 2 doing today",
            "training plan for the company",
            "company's schedule for the week",
            "company training calendar",
            "unit schedule",
            "what's the company doing this week",
            "company's weekly plan",
        ...
        "bydate": (
            ...
            "training on a particular date",
            "plan for that date",
            "what was scheduled on",
            "training on a given date",
            "plan for a chosen date",
        ),
        "byagniveer": (
            "agniveer schedule",
            ...
            "what's on his plate today",
            "his training calendar",
        ),
    },
    "personaldetail": {
        "info": (
    ...
    "Overall": {
        "OverallPerformance": (
            ...
            "best overall",
            "overall best agniveer",
            "ranking across everything",
            "how's he doing across the board",
    ...
    "OrgHierarchy": {
        ...
        "HistoricalOfficer": (
            ...
            "who commanded it before",
            "prior commanding officer",
            "commander a year ago",
            "tenure",
            "who commanded a year back",
            "officer before this one",
        ...
        "PlatoonsUnderCompany": (
            ...
            "list platoons under",
            "platoons in",
            "how many platoons does the company have",
            "platoons that report to",
            "platoons falling under",
            "list of platoons in the company",
            "how many platoons in this company",
            "platoons that belong to",
        ),
        "HeadcountByCompany": (
            "headcount by company",
            ...
            "how many agniveers per company",
            "company size breakdown",
            "number of agniveers in each company",
            "how many in each company",
        ),
        "TopCompanyByHeadcount": (
            "which company has the most",
            "which company has the highest headcount",
            ...
            "biggest company by strength",
            "company with the highest strength",
            "which company is the biggest",
            "strongest company by numbers",
            "which company has the most people",
        ),
        "WhichCompanyForAgniveer": (
            "which company is agniveer",
            "which company for agniveer",
            ...
            "what unit is he posted to",
            "where is he posted",
            "which company is he part of",
...
SECTION: Dict[str, Dict[str, Any]] = {
    "BPET": {
        ...
        "aliases": (
            ...
            "betp",
            "bept",
            "battle physical efficiency test",
...
LEAVE_TYPES: Dict[str, str] = {
    ...
    "earned leave": "Annual",
    "hospital leave": "Medical",
    "health leave": "Medical",
    "hospitalised": "Hospitalized",
    "limit": "Threshold",
    "crossed limit": "Threshold",
}
...
def _extend_skills_keywords() -> None:
    ...
    sport_additions = tuple(k for k in SPORTS if k not in base) + tuple(
